...
<div id="page" class="hfeed site">
    ...
    <div id="main" class="site-main">
        <form id="mypost" method="post" action="updatePost2" enctype="multipart/form-data">
            <p>
              <p>帖子标题：<input type="text" name="posttitle" value="${sessionScope.mypostlm.jn_posttitle}"></p>
               <span> 帖子封面</span> <input type="file" id="attach-file" name="jn_logo"  onchange="previewFile()">
            </p>
            <c:if test="${sessionScope.mypostlm.jn_logo==null}">
            <img src="picture/3.jpg" width="200" height="140"  id="mylogo"/><br />
            </c:if>
            <c:if test="${sessionScope.mypostlm.jn_logo!=null}">
                <img src="${sessionScope.mypostlm.jn_logo}" width="200" height="140"  id="mylogo"/><br />
            </c:if>
            <p><textarea id="myeditor" name="postcontent" onfocus="if (value=='帖子内容:'){value='帖子内容'}" onblur="if (value==''){value='帖子内容'} ">${sessionScope.mypostlm.jn_postcontent}</textarea></p>
