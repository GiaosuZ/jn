                        ...
                        <article class="hentry page">
                            ...
                            <div class="entry-content">
                              ...
                              <form action="Login" method="post" class="validate-form">
                                ...
                                <p>
                                  <label for="your_name">用户名 *</label>
                                  <input type="text" name="your_name" id="your_name" class="required">
                                </p>
                                
                                <p>
                                  <label for="your_password">密码 *</label>
                                  <input type="password" name="your_password" id="your_password" class="required password">
                                </p>
                                <!-- 
                                <p>
                                ...
                                <!--<p>
                                  <label for="budgetm">Budget Multi</label>
                                  <select name="budgetm" id="budgetm" multiple="multiple">
                                    <option value="1000$">1000$</option>
                                    <option value="2000$">2000$</option>
                                    <option value="3000$">3000$</option>
                                    <option value="5000$+">5000$+</option>
                               ...
                               <!-- <p>
                                ...
                                <p>
                                  <input type="submit" value="登 录">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="button" value="注 册" onclick="registerchack()">
                                </p>
                              </form>
                ...
                <!-- <div class="footer-sidebar widget-area" role="complementary"> -->
                   ...
                   <!-- <aside class="widget widget_text">
                      ...
                      <div class="textwidget">
                        <img src="picture/about-small.jpg" alt="avatar"> <p>Hello. I am a freelance writer. I live in a small town somewhere in the world.</p>
                      </div>
                    </aside> -->
                    <!-- widget -->        
