                        ...
                        for (var i=0;i<msg.data.length;i++){
                            if (msg.data[i].jn_logo!=null) {
                                str2=str2+"<article class=\"hentry post\">\n" +
                                    ...
                                    "                                <a href=\"getPostid?postid="+msg.data[i].jn_postid+"\"><img src='upload/"+msg.data[i].jn_logo+"' alt=\"blog-image\"></a>\n" +
                                    "                            </div>\n" +
                                    "                            <!-- .featured-image -->\n" +
                                    "\n" +
                                    "\n" +
                                    ...
                                    "\n" +
                                    "                                <!-- .entry-title -->\n" +
                                    "                                <h1 class=\"entry-title\"><a href=\"getPostid?postid="+msg.data[i].jn_postid+"\">"+msg.data[i].jn_posttitle+"</a></h1>\n" +
                                    "\n" +
                                    "\n" +
                                    "                                <!-- .entry-meta -->\n" +
                    ...
                    for (var i=0;i<msg.data.length;i++){
                        ...
                        if (msg.data[i].jn_logo!=null) {
                            str2=str2+"<article class=\"hentry post\">\n" +
                                ...
                                "                                        </span>\n" +
                                "                                    <span class=\"comment-link\">\n" +
                                "                                            <a href=\"getPostid?postid="+msg.data[i].jn_postid+"\">124 Comments</a>\n" +
                                "                                        </span>\n" +
                                "                                    <span class=\"read-time\"><span class=\"eta\"></span> read</span>\n" +
                                "                                    <span class=\"cat-links\">\n" +
                                "                                            <a href=\"#\" title=\"View all posts in Adventure\" rel=\"category tag\">LIFE</a>\n" +
