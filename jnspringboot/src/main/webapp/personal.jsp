                    ...
                    for (var i=0;i<msg.data.length;i++){
                        if (msg.data[i].jn_logo==null) {
                            str=str+'<article class="hentry post"><div class="featured-image"><a href="#"><img src="picture/10.jpg" alt="blog-image"></a></div><header class="entry-header"><h1 class="entry-title"><a href="#">'+msg.data[i].jn_posttitle+'</a>\n' +
                                '                        </h1><div class="entry-meta"><span class="entry-date"><time class="entry-date" datetime="2014-07-13T04:34:10+00:00">'+msg.data[i].jn_posttime+'❤&nbsp;'+msg.data[i].jn_likes+'&nbsp;&nbsp;&nbsp;👁&nbsp;'+msg.data[i].jn_views+'</time></span><span class="comment-link"><a href="#"></a>\n' +
                                '                                        </span><span class="read-time"><span class="eta"></span> read</span><span class="cat-links"><a href="removePost?jn_postid='+msg.data[i].jn_postid+'">删除</a><a href="updatepost.jsp?post='+msg.data+'">修改</a>\n' +
                                '                                        </span></div></header>\n' +
                                '                        </article>'


                        }else{
                            str=str+'<article class="hentry post"><div class="featured-image"><a href="#"><img src="upload/'+msg.data[i].jn_logo+'" alt="blog-image"></a></div><header class="entry-header"><h1 class="entry-title"><a href="#">'+msg.data[i].jn_posttitle+'</a>\n' +
                                '                        </h1><div class="entry-meta"><span class="entry-date"><time class="entry-date" datetime="2014-07-13T04:34:10+00:00">'+msg.data[i].jn_posttime+'❤&nbsp;'+msg.data[i].jn_likes+'&nbsp;&nbsp;&nbsp;👁&nbsp;'+msg.data[i].jn_views+'</time></span><span class="comment-link"><a href="#"></a>\n' +
                                '                                        </span><span class="read-time"><span class="eta"></span> read</span><span class="cat-links"><a href="removePost?jn_postid='+msg.data[i].jn_postid+'">删除</a><a href="updatepost.jsp?post='+msg.data+'">修改</a>\n' +
                                '                                        </span></div></header>\n' +
                                '                        </article>'}
            ...
            if (msg.data!=null&&msg.data.length>0) {
                for (var i=0;i<msg.data.length;i++){
                    if (msg.data[i].jn_logo==null) {
                        str=str+'<article class="hentry post"><div class="featured-image"><a href="#"><img src="picture/10.jpg" alt="blog-image"></a></div><header class="entry-header"><h1 class="entry-title"><a href="#">'+msg.data[i].jn_posttitle+'</a>\n' +
                            '                        </h1><div class="entry-meta"><span class="entry-date"><time class="entry-date" datetime="2014-07-13T04:34:10+00:00">'+msg.data[i].jn_posttime+'❤&nbsp;'+msg.data[i].jn_likes+'&nbsp;&nbsp;&nbsp;👁&nbsp;'+msg.data[i].jn_views+'</time></span><span class="comment-link"><a href="#"></a>\n' +
                            '                                        </span><span class="read-time"><span class="eta"></span> read</span><span class="cat-links"><a href="removePost?jn_postid='+msg.data[i].jn_postid+'">删除</a><a href="updatepost?jn_post='+msg.data[i]+'">修改</a>\n' +
                            '                                        </span></div></header>\n' +
                            '                        </article>'
                    ...
                    str=str+'<article class="hentry post"><div class="featured-image"><a href="#"><img src="upload/'+msg.data[i].jn_logo+'" alt="blog-image"></a></div><header class="entry-header"><h1 class="entry-title"><a href="#">'+msg.data[i].jn_posttitle+'</a>\n' +
                        '                        </h1><div class="entry-meta"><span class="entry-date"><time class="entry-date" datetime="2014-07-13T04:34:10+00:00">'+msg.data[i].jn_posttime+'❤&nbsp;'+msg.data[i].jn_likes+'&nbsp;&nbsp;&nbsp;👁&nbsp;'+msg.data[i].jn_views+'</time></span><span class="comment-link"><a href="#"></a>\n' +
                        '                                        </span><span class="read-time"><span class="eta"></span> read</span><span class="cat-links"><a href="removePost?jn_postid='+msg.data[i].jn_postid+'">删除</a><a href="jn_postid='+msg.data[i].jn_postid+'">修改</a>\n' +
                        '                                        </span></div></header>\n' +
                        '                        </article>'}
                        ...
                        for (var i=0;i<msg.data.length;i++){
                            if (msg.data[i].jn_logo==null) {
                                str=str+'<li>\n' +
                                    ...
                                    '                                        <a href="#" class="tptn_link"><span class="tptn_title">'+msg.data[i].jn_posttitle+'</span></a>\n' +
                                    '                                    <!--<span class="tptn_author"> by <a href="#">Johnny Doe</a></span>-->\n' +
                                    '                                        <span class="tptn_date">'+msg.data[i].jn_posttime+'</span>\n' +
                                    '                                    </span>\n' +
                                    '                            </li>'
                                ...
                                str=str+'<li>\n' +
                                    '                                <a href="#" class="tptn_link">\n' +
                                    '                                    <img src="upload/'+msg.data[i].jn_logo+'" alt="post-image" class="tptn_thumb">\n' +
                                    '                                </a>\n' +
                                    '                                <span class="tptn_after_thumb">\n' +
                                    '                                        <a href="#" class="tptn_link"><span class="tptn_title">'+msg.data[i].jn_posttitle+'</span></a>\n' +
                                    '                                    <!--<span class="tptn_author"> by <a href="#">Johnny Doe</a></span>-->\n' +
...
<div id="page" class="hfeed site">
    ...
    <div id="main" class="site-main">
        ...
        <div class="layout-medium">
            ...
            <!-- #secondary -->
<jsp:include page="addsecondary.jsp"></jsp:include>
            <!-- #secondary -->
