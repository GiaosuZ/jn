...
public class CollectionDto {
    ...
    public CollectionDto(Integer jn_userid, String jn_username, String jn_userpwd, String jn_usertel, String jn_useremail, String jn_userstatus, String jn_userlogo, String jn_usersex, String jn_usersigature, Integer jn_postid, String jn_posttitle, String jn_postcontent, String jn_poststatus, String jn_posttime, Integer jn_likes, Integer jn_collection, String jn_logo, Integer jn_views, Integer jn_heat) {
        this.jn_userid = jn_userid;
        this.jn_username = jn_username;
        this.jn_userpwd = jn_userpwd;
        this.jn_usertel = jn_usertel;
